...
public class CustomerController {
	...
	public ResponseEntity<?> createCustomer(@RequestBody Customer customer) {
		try {
			// TODO : Add logic to Hash Customer PIN here -done

			String HashedPin = bCryptPasswordEncoder.encode(customer.getPin());

			// TODO : Add logic to check if Customer with provided username, or -done
			...
			if(customerRepository.findByCustomerId(customer.getCustomerId()).isPresent()){
				...
				throw new Exception("Customer with id" +customer.getCustomerId()+"exists");
			}
